...
`
  ...
  function De(e, t, r, n, i) {
    if (Ie && typeof t == "function") {
      ...
      o instanceof Promise
        ? o.then((s) => De(e, s, r, n)).catch((s) => te(s, i, t))
        : e(o);
    } else
  ...
  function gi(e = !1) {
    return function (r, n, i, o) {
      ...
      return (
        r === _(o) &&
          (a ? Nt(i, s) && V(r, "set", n, i, s) : V(r, "add", n, i)),
        c
      );
    };
  }
  ...
  function Je(e, t = !1) {
    return (
      (e = e.__v_raw), !t && M(_(e), "iterate", X), Reflect.get(e, "size", e)
    );
  }
  function Gr(e) {
    e = _(e);
  ...
  function Jr(e, t) {
    ...
    return (
      r.set(e, t),
      o ? Nt(t, s) && V(r, "set", e, t, s) : V(r, "add", e, t),
      this
    );
  }
  function Yr(e) {
  ...
  function Ye(e, t) {
    return function (n, i) {
      let o = this,
        ...
        c = t ? jt : e ? $t : Lt;
      return (
        !e && M(a, "iterate", X), s.forEach((l, u) => n.call(i, c(l), c(u), o))
      );
    };
  }
  function Xe(e, t, r) {
  ...
  y(
    "refs",
    (e) => (e._x_refs_proxy || (e._x_refs_proxy = F(Di(e))), e._x_refs_proxy),
  );
  function Di(e) {
    let t = [],
      r = e;
